package com.sbw.mybatis.generator.plugin;
...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.sbw.mybatis.help.DbField");
        root.addImportedType("com.sbw.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.sbw.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.sbw.mybatis.help.FieldResult"));

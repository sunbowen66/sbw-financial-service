...
public interface ObjectConvertor {
    ...
    @Mappings({
            @Mapping(target = "valueAddedTaxCate", expression = "java(com.sbw.finance.biz.enums.ValueAddedTaxCateEnum.getMessage(source.getValueAddedTaxCate()))"),
            @Mapping(target = "accountingStandard", expression = "java(com.sbw.finance.biz.enums.AccountingStandardEnum.getMessage(source.getAccountingStandard()))")
    })
